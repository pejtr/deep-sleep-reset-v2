...
export const abEvents = mysqlTable("ab_events", {
  id: int("id").autoincrement().primaryKey(),
  /** Which variant was shown: quiz | chatbot | social | btn_amber | btn_green | btn_blue | price_5 | price_7 | cta_a | cta_b | cta_c | squeeze_a | squeeze_b */
  variant: mysqlEnum("variant", ["quiz", "chatbot", "social", "btn_amber", "btn_green", "btn_blue", "price_5", "price_7", "cta_a", "cta_b", "cta_c", "squeeze_a", "squeeze_b"]).notNull(),
